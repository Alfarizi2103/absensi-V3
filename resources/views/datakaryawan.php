                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" role="button" href="edit.php?id=<?php echo $data['id']; ?>"> Edit</a>  <a class="btn btn btn-warning" role="button" href="hapus.php?id=<?php echo $data['id']; ?>"> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
